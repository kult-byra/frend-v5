...
// Query: *[slug.current == $slug && language == $currentLocale][0] {    "_translations": *[_type == "translation.metadata" && references(^._id)].translations[].value->{      "slug": slug.current,      language    }  }

      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
        <section>
          <div className="flex items-center justify-between mb-4">
            <H2>Artikler</H2>
            <Link href="/kunnskap/artikler" className="text-sm text-primary hover:underline">
              Se alle →
            </Link>
          </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <H2>Prosjekter</H2>
            <Link href="/prosjekter" className="text-sm text-primary hover:underline">
              Se alle →
            </Link>
          </div>
          <div className="space-y-3">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <H2>Seminarer</H2>
            <Link href="/seminarer" className="text-sm text-primary hover:underline">
              Se alle →
            </Link>
          </div>
          <div className="space-y-3">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <H2>E-bøker</H2>
            <Link href="/e-boker" className="text-sm text-primary hover:underline">
              Se alle →
            </Link>
          </div>
          <div className="space-y-3">
